...
import { realMarketDataService } from '@/lib/realMarketDataService'
import { realScreeningService } from '@/lib/realScreeningService'
  ...
  const handleRefresh = useCallback(async () => {
    ...
    try {
      ...
      const dataPromise = Promise.allSettled([
        realMarketDataService.getRealNifty50Overview(),
        realScreeningService.runRealScreening(),
